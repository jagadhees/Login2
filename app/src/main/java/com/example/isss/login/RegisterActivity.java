package com.example.isss.login;
...
import com.example.isss.login.R;
import com.example.isss.login.InputValidation;
import com.example.isss.login.User;
import com.example.isss.login.DatabaseHelper;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        appCompatButtonView = (AppCompatButton) findViewById(R.id.appCompatButtonView);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.appCompatButtonView:
                ...
                Intent intentView = new Intent(getApplicationContext(), UsersListActivity.class);
